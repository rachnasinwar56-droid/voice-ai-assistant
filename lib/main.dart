...
class _SiriHomeState extends State<SiriHome> {
  ...
  Future<void> _speak(String text) async {
    ...
    try {
      ...
      // Hindi voice if available; otherwise TTS automatically falls back.
...
class GeminiService {
  ...
  Future<String> ask(String prompt) async {
    ...
    String lastError = 'No response from Gemini.';
              ...
              body: jsonEncode({
                'system_instruction': {
                  'parts': [
                    {
                      'text': '''
You are Siri, a friendly personal AI assistant.
...
- Never claim you performed a device action unless the app
